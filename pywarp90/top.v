top
#@(#) File TOP.V, version $Revision: 3.40 $, $Date: 2002/03/27 21:31:08 $
...
verstop character*19 /"$Revision: 3.40 $"/ # Global common version, set by CVS
...
zwindows(2,0:NWINDOWS)    real  [m] /-99.,99.,TNWINM*0./ +parallel
...
inject    integer    /0/   # Type of injection, (0: turned off,
                           # 1: constant current,
                           # 2: space-charge limited (Gauss's law),
                           # 3: space-charge limited (Child-Langmuir))
...
parallelsumrealarray(data:real,ndata:integer) subroutine
