f3d
#@(#) File F3D.V, version $Revision: 3.148 $, $Date: 2006/02/17 23:51:09 $
...
*********** F3Dversion:
versf3d character*19 /"$Revision: 3.148 $"/#  Code version version is set by CVS
...
loadj3d(ins:integer,nps:integer,is:integer,lzero:logical,pgroup:ParticleGroup) 
