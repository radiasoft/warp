...
[wxID_PARTICLEPLOTSGUI, wxID_PARTICLEPLOTSGUICELLARRAY, 
 ...
 wxID_PARTICLEPLOTSGUIFMA, wxID_PARTICLEPLOTSGUIFMABEFOREPLOT, 
 wxID_PARTICLEPLOTSGUIHCP, wxID_PARTICLEPLOTSGUIIZSLIDER, 
 ...
 wxID_PARTICLEPLOTSGUISTATICLINE4, wxID_PARTICLEPLOTSGUISTATICLINE5, 
...
class ParticlePlotsGUI(wxPanel):
    ...
    def _init_ctrls(self, prnt):
        ...
        wxPanel.__init__(self, id=wxID_PARTICLEPLOTSGUI, name='', parent=prnt,
              pos=wxPoint(453, 205), size=wxSize(548, 350),
              style=wxTAB_TRAVERSAL)
        self._init_utils()
        self.SetClientSize(wxSize(548, 350))

        self.ppxy = wxButton(id=wxID_PARTICLEPLOTSGUIPPXY, label='ppxy',
              name='ppxy', parent=self, pos=wxPoint(72, 8), size=wxSize(56, 22),
              style=0)
        ...
        self.ppxxp = wxButton(id=wxID_PARTICLEPLOTSGUIPPXXP, label='ppxxp',
              name='ppxxp', parent=self, pos=wxPoint(136, 8), size=wxSize(56,
              22), style=0)
        ...
        self.ppyyp = wxButton(id=wxID_PARTICLEPLOTSGUIPPYYP, label='ppyyp',
              name='ppyyp', parent=self, pos=wxPoint(72, 40), size=wxSize(56,
              22), style=0)
        ...
        self.ppxpyp = wxButton(id=wxID_PARTICLEPLOTSGUIPPXPYP, label='ppxpyp',
              name='ppxpyp', parent=self, pos=wxPoint(136, 40), size=wxSize(56,
              22), style=0)
        ...
        self.pptrace = wxButton(id=wxID_PARTICLEPLOTSGUIPPTRACE,
              label='pptrace', name='pptrace', parent=self, pos=wxPoint(72, 72),
        ...
        self.izslider = wxSlider(id=wxID_PARTICLEPLOTSGUIIZSLIDER, maxValue=100,
              minValue=0, name='izslider', parent=self, point=wxPoint(72, 112),
              size=wxSize(112, 35),
        ...
        self.fma = wxButton(id=wxID_PARTICLEPLOTSGUIFMA, label='fma',
              name='fma', parent=self, pos=wxPoint(8, 8), size=wxSize(40, 38),
              style=0)
        self.fma.SetToolTipString('Frame Advance')
        EVT_BUTTON(self.fma, wxID_PARTICLEPLOTSGUIFMA, self.OnFmaButton)

        self.hcp = wxButton(id=wxID_PARTICLEPLOTSGUIHCP, label='hcp',
              name='hcp', parent=self, pos=wxPoint(8, 56), size=wxSize(40, 38),
              style=0)
        self.hcp.SetToolTipString('Hard Copy')
        EVT_BUTTON(self.hcp, wxID_PARTICLEPLOTSGUIHCP, self.OnHcpButton)

        self.plotchoice = wxChoice(choices=['iw', 'iz', 'iy', 'ix'],
              id=wxID_PARTICLEPLOTSGUIPLOTCHOICE, name='plotchoice',
              parent=self, pos=wxPoint(8, 112), size=wxSize(60, 25), style=0,
        ...
        self.Contours = wxRadioButton(id=wxID_PARTICLEPLOTSGUICONTOURS,
              label='Contours', name='Contours', parent=self, pos=wxPoint(392,
        ...
        self.Density = wxRadioButton(id=wxID_PARTICLEPLOTSGUIDENSITY,
              label='Density', name='Density', parent=self, pos=wxPoint(392,
        ...
        self.Cellarray = wxRadioButton(id=wxID_PARTICLEPLOTSGUICELLARRAY,
              label='Cellarray', name='Cellarray', parent=self, pos=wxPoint(392,
        ...
        self.Surface = wxRadioButton(id=wxID_PARTICLEPLOTSGUISURFACE,
              label='Surface', name='Surface', parent=self, pos=wxPoint(392,
        ...
        self.Palette = wxChoice(choices=["earth", "rainbow", "gray", "yarg",
              ...
              pos=wxPoint(392, 96), size=wxSize(112, 25), style=0,
              validator=wxDefaultValidator)
        ...
        self.Particles = wxRadioButton(id=wxID_PARTICLEPLOTSGUIPARTICLES,
              label='Particles', name='Particles', parent=self, pos=wxPoint(392,
        ...
        self.PlotRefresh = wxCheckBox(id=wxID_PARTICLEPLOTSGUIPLOTREFRESH,
              ...
              pos=wxPoint(8, 152), size=wxSize(128, 24), style=0)
        ...
        self.staticLine1 = wxStaticLine(id=wxID_PARTICLEPLOTSGUISTATICLINE1,
              name='staticLine1', parent=self, pos=wxPoint(192, 0),
              size=wxSize(16, 208), style=wxLI_VERTICAL)

        self.staticLine2 = wxStaticLine(id=wxID_PARTICLEPLOTSGUISTATICLINE2,
              name='staticLine2', parent=self, pos=wxPoint(376, 0),
              size=wxSize(20, 208), style=wxLI_VERTICAL)

        self.staticLine3 = wxStaticLine(id=wxID_PARTICLEPLOTSGUISTATICLINE3,
              name='staticLine3', parent=self, pos=wxPoint(0, 144),
              size=wxSize(200, 16), style=wxLI_HORIZONTAL)

        self.staticLine4 = wxStaticLine(id=wxID_PARTICLEPLOTSGUISTATICLINE4,
              name='staticLine4', parent=self, pos=wxPoint(48, 0),
              size=wxSize(20, 104), style=wxLI_VERTICAL)

        self.staticLine5 = wxStaticLine(id=wxID_PARTICLEPLOTSGUISTATICLINE5,
              name='staticLine5', parent=self, pos=wxPoint(0, 96),
              size=wxSize(200, 16), style=wxLI_HORIZONTAL)

        self.ppzx = wxButton(id=wxID_PARTICLEPLOTSGUIPPZX, label='ppzx',
              name='ppzx', parent=self, pos=wxPoint(216, 8), size=wxSize(56,
              22), style=0)
        ...
        self.ppzxp = wxButton(id=wxID_PARTICLEPLOTSGUIPPZXP, label='ppzxp',
              name='ppzxp', parent=self, pos=wxPoint(216, 40), size=wxSize(56,
              22), style=0)
        ...
        self.ppzyp = wxButton(id=wxID_PARTICLEPLOTSGUIPPZYP, label='ppzyp',
              name='ppzyp', parent=self, pos=wxPoint(280, 40), size=wxSize(56,
              22), style=0)
        ...
        self.ppzy = wxButton(id=wxID_PARTICLEPLOTSGUIPPZY, label='ppzy',
              name='ppzy', parent=self, pos=wxPoint(280, 8), size=wxSize(56,
              22), style=0)
        ...
        self.fmabeforeplot = wxCheckBox(id=wxID_PARTICLEPLOTSGUIFMABEFOREPLOT,
              ...
              parent=self, pos=wxPoint(8, 176), size=wxSize(184, 24), style=0)
