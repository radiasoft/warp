...
import sys
import string
warpplots_version = "$Id: warpplots.py,v 1.272 2011/01/14 01:34:01 rcohen Exp $"
...
ptitle_placement = [
  ...
  [],
  [],
  [[0.3950, 0.9053], [0.3950, 0.7486], [0.1300, 0.7975], [0.397, 0.37]],
  [[0.3950, 0.7298], [0.3950, 0.5731], [0.1300, 0.6220], [0.397, 0.37]],
  [[0.3950, 0.5544], [0.3950, 0.3977], [0.1300, 0.4465], [0.397, 0.37]]]
